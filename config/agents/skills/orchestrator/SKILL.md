---
name: orchestrator
description: "Coordinate work across Herdr panes in a project workspace. Use for handoffs between agents, reviewer escalation after finish-work, context sync when agent status changes, and reactive watch-events. Requires HERDR_ENV=1 and an enabled [herdr.orchestrator] profile."
---
